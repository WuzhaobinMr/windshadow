	...
	<div class="header">
		<div class="container">
			<div class="w3layouts_logo">
				<a href="index.html"><h1>大B哥<span>Movies</span></h1></a>
			</div>
			<div class="w3_search">
								...
								<ul class="dropdown-menu multi-column columns-3">
									...
									<div class="col-sm-4">
										<ul class="multi-column-dropdown">
											<c:forEach items="${Sorts}" begin="0" end="7" step="1" var="Sort">
									...
									<div class="col-sm-4">
										<ul class="multi-column-dropdown">
											<c:forEach items="${Sorts}" begin="8" end="13" step="1" var="Sort">
												<li><a href="#">${Sort.name}</a></li>
											</c:forEach>
										</ul>
									</div>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi-column columns-3">
									<li>
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<c:forEach items="${Areas}" begin="0" end="5" step="1" var="Area">
										...
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<c:forEach items="${Areas}" begin="5" end="9" step="1" var="Area">
													<li><a href="#">${Area.name}</a></li>
												</c:forEach>
											</ul>
										</div>
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<c:forEach items="${Areas}" begin="9" end="13" step="1" var="Area">
													<li><a href="#">${Area.name}</a></li>
												</c:forEach>
											</ul>
										</div>
...
<!-- banner -->
	<div id="slidey" style="display:none;">
		<ul>
		<c:forEach items="${NewFilm}"  var="Film">
			<li><img src="${Film.hoto}" alt=" "><p class='title'>${Film.name}</p><p class='description'>${Film.intro}</p></li>
		</c:forEach>
		</ul>
    </div>
					...
					<c:forEach items="${Film}" var="Film">
						<div class="item">
							<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
								<a href="tt" class="hvr-shutter-out-horizontal" ><img src="${Film.hoto}" title="点击购票" style="" class="img-responsive" alt="${Film.name}" />
								</a>
		...
		<div class="container">
			<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				<ul id="myTab" class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"><a href="#imdb" role="tab" id="imdb-tab" data-toggle="tab" aria-controls="imdb" aria-expanded="false">最近上映的</a></li>
				</ul>
		...
		<div class="container">
			<div class="w3ls_footer_grid">
				...
				<div class="col-md-6 w3ls_footer_grid_right">
					<a href="index.html"><h2>大B哥<span>电影</span></h2></a>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="col-md-5 w3ls_footer_grid1_left">
			</div>
			<p>Copyright &copy; 2016.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="风影">风影</a> - Collect from <a href="http://www.cssmoban.com/" title="Movies" target="_blank">Movies</a></p>
