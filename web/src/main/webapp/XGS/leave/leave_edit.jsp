...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="action divaction">
		...
		<div class="pages">
	<!--请假申请 区域 开始-->
	<s:form action="leave_saveLeaveadd" name="leaveForm">
     <table class="leave">
       <tr>
         ...
         <s:hidden name="leave.employee_sn.sn" value="%{#session.employee.sn}"></s:hidden>
         <td class="width1"><label>部门：</label></td>
         <td class="width2">
            <select name="" class="nwselect">
             <option value="<s:property value="#session.employee.sys_department.id"/>"><s:property value="#session.employee.sys_department.name"/></option>
           </select>
         </td>
       </tr>
        <tr>
        ...
        <tr>
         ...
         <td class="width2">
            <s:select name="leave.leavetype" list="#session.leaveTypeMap" 
       ...
       <tr>
         ...
         <td colspan="3">
          ...
          <p class="leave">
           <label>下一审批人：</label>
           <select name="leave.next_deal_sn.sn" class="nwselect" >
             <option value="<s:property value="#session.Sys_employee.sn"/>"><s:property value="#session.Sys_employee.name"/></option>
           </select>
          </p>
          <p class="marg">
